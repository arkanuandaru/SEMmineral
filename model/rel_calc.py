...
def rel_calc(trained_cl_seg, cl_trn_folder, shift_x, shift_y):
    ...
    mask_yellow = cv2.inRange(img_rgb, (255,255,0), (255,255,0))
    mask_red = cv2.inRange(img_rgb, (255,0,0), (255,0,0))
    mask_green = cv2.inRange(img_rgb, (0,255,0), (0,255,0))
    mask_black = cv2.inRange(img_rgb, (0,0,0), (0,0,0))
